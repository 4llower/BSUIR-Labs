...
namespace lab_work_task_5
{
    public class Food
    {
        ...
        public Food(string name, double weight, double calorificValue, double carbohydrates, double fats, double proteins)
        {
            Id = currentFreeId++;
            Name = name;
            Weight = weight;
        ...
        public Food(string name, double weight, double calorificValue, double carbohydrates, double fats, double proteins, string datePut, FoodHeat foodHeat) :
                this(name, weight, calorificValue, carbohydrates, fats, proteins)
        {
            PutDate = datePut;
        ...
        public override string ToString()
        {
            ...
            result.AppendLine("|" + String.Format("|->CalorificValue: {0:f} |", CalorificValue).PadRight(lenTable - 1, '='));
